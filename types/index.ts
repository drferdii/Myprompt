...
export const DesktopWorkspaceSourceModeSchema = z.enum([
  'transform',
  'optimize',
  'evaluate',
])
export type DesktopWorkspaceSourceMode = z.infer<
  typeof DesktopWorkspaceSourceModeSchema
>
...
export type DesktopBenchmarkBudget = z.infer<
  typeof DesktopBenchmarkBudgetSchema
>
...
export type DesktopBenchmarkBudgets = z.infer<
  typeof DesktopBenchmarkBudgetsSchema
>
...
export const DesktopBenchmarkCaseInputSchema =
  DesktopBenchmarkCaseInputBaseSchema.superRefine(
    validateDesktopBenchmarkLaneBudgets
  )
export type DesktopBenchmarkCaseInput = z.infer<
  typeof DesktopBenchmarkCaseInputSchema
>

export const DesktopBenchmarkCaseSchema = DesktopBenchmarkCaseInputBaseSchema
  .extend({
    createdAt: z.string().datetime(),
    updatedAt: z.string().datetime(),
  })
...
export type DesktopWorkspaceSnapshot = z.infer<
  typeof DesktopWorkspaceSnapshotSchema
>
